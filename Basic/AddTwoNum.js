...
// Here, prompt() is used to take inputs from the user. parseInt() 
...
// Finally, the sum is displayed. To display the result, we have used the 
// template literal ` `. This allows us to include variables inside strings.
